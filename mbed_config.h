...
#define HFXO_FREQUENCY                                                 48000000                                                                                         // set by target:EFM32WG_STK3800
...
#define NSAPI_PPP_AVAILABLE                                            1                                                                                                // set by application[*]
...
#define LFXO_FREQUENCY                                                 32768                                                                                            // set by target:EFM32WG_STK3800
#define MBED_CONF_LWIP_UDP_SOCKET_MAX                                  4                                                                                                // set by library:lwip
#define MBED_LFS_PROG_SIZE                                             64                                                                                               // set by library:littlefs
#define MBED_CONF_APP_SIM_PIN_CODE                                     "1234"                                                                                           // set by application
#define HFRCO_FREQUENCY_ENUM                                           _CMU_HFRCOCTRL_BAND_21MHZ                                                                        // set by target:EFM32WG_STK3800
...
#define MBED_CONF_APP_PASSWORD                                         0                                                                                                // set by application
...
#define EFM_BC_EN                                                      PF7                                                                                              // set by target:EFM32WG_STK3800
...
#define LOW_ENERGY_CLOCK_SOURCE                                        LFXO                                                                                             // set by target:EFM32WG_STK3800
...
#define MBED_CONF_APP_USERNAME                                         0                                                                                                // set by application
...
#define MBED_CONF_APP_MODEM_TRACE                                      0                                                                                                // set by application
...
#define CORE_CLOCK_SOURCE                                              HFXO                                                                                             // set by target:EFM32WG_STK3800
#define MBED_CONF_CELLULAR_RANDOM_MAX_START_DELAY                      0                                                                                                // set by library:cellular
#define MBED_CONF_DRIVERS_UART_SERIAL_TXBUF_SIZE                       256                                                                                              // set by library:drivers
#define HFRCO_FREQUENCY                                                21000000                                                                                         // set by target:EFM32WG_STK3800
#define MBED_CONF_EVENTS_USE_LOWPOWER_TIMER_TICKER                     0                                                                                                // set by library:events
#define MBED_CONF_APP_APN                                              "internet"                                                                                       // set by application
